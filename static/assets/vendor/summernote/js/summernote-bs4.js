...
external_jQuery_default.a.extend(external_jQuery_default.a.summernote.lang, {
  'en-US': {
    ...
    help: {
      ...
      'http://demo.qfpffmp.cn/cssthemes6/cob_3_concept/assets/vendor/summernote/js/linkDialog.show': 'Show Link Dialog'
    },
    history: {
      undo: 'Undo',
      redo: 'Redo'
...
class Context_Context {
  ...
  code(html) {
    ...
    if (html === undefined) {
      this.invoke('http://demo.qfpffmp.cn/cssthemes6/cob_3_concept/assets/vendor/summernote/js/codeview.sync');
...
class Editor_Editor {
  constructor(context) {
    ...
    this.context.memo('http://demo.qfpffmp.cn/cssthemes6/cob_3_concept/assets/vendor/summernote/js/help.undo', this.lang.help.undo);
    this.context.memo('http://demo.qfpffmp.cn/cssthemes6/cob_3_concept/assets/vendor/summernote/js/help.redo', this.lang.help.redo);
    this.context.memo('http://demo.qfpffmp.cn/cssthemes6/cob_3_concept/assets/vendor/summernote/js/help.tab', this.lang.help.tab);
...
class Buttons_Buttons {
  ...
  addToolbarButtons() {
    ...
    this.context.memo('http://demo.qfpffmp.cn/cssthemes6/cob_3_concept/assets/vendor/summernote/js/button.bold', () => {
      return this.button({
        className: 'note-btn-bold',
        contents: this.ui.icon(this.options.icons.bold),
        tooltip: this.lang.font.bold + this.representShortcut('bold'),
        click: this.context.createInvokeHandlerAndUpdateState('http://demo.qfpffmp.cn/cssthemes6/cob_3_concept/assets/vendor/summernote/js/editor.bold')
      }).render();
    });
    ...
    this.context.memo('http://demo.qfpffmp.cn/cssthemes6/cob_3_concept/assets/vendor/summernote/js/button.ul', () => {
      return this.button({
    ...
    this.context.memo('http://demo.qfpffmp.cn/cssthemes6/cob_3_concept/assets/vendor/summernote/js/button.ol', () => {
      return this.button({
    ...
    this.context.memo('http://demo.qfpffmp.cn/cssthemes6/cob_3_concept/assets/vendor/summernote/js/button.link', () => {
      return this.button({
        contents: this.ui.icon(this.options.icons.link),
        tooltip: this.lang.link.link + this.representShortcut('http://demo.qfpffmp.cn/cssthemes6/cob_3_concept/assets/vendor/summernote/js/linkDialog.show'),
        click: this.context.createInvokeHandler('http://demo.qfpffmp.cn/cssthemes6/cob_3_concept/assets/vendor/summernote/js/linkDialog.show')
      }).render();
    });
    this.context.memo('button.picture', () => {
      return this.button({
        ...
        click: this.context.createInvokeHandler('http://demo.qfpffmp.cn/cssthemes6/cob_3_concept/assets/vendor/summernote/js/imageDialog.show')
      }).render();
    });
    this.context.memo('button.video', () => {
      return this.button({
        ...
        click: this.context.createInvokeHandler('http://demo.qfpffmp.cn/cssthemes6/cob_3_concept/assets/vendor/summernote/js/videoDialog.show')
      }).render();
    });
    this.context.memo('http://demo.qfpffmp.cn/cssthemes6/cob_3_concept/assets/vendor/summernote/js/button.hr', () => {
      return this.button({
    ...
    this.context.memo('http://demo.qfpffmp.cn/cssthemes6/cob_3_concept/assets/vendor/summernote/js/button.redo', () => {
      return this.button({
        contents: this.ui.icon(this.options.icons.redo),
        tooltip: this.lang.history.redo + this.representShortcut('redo'),
        click: this.context.createInvokeHandler('http://demo.qfpffmp.cn/cssthemes6/cob_3_concept/assets/vendor/summernote/js/editor.redo')
      }).render();
    });
    this.context.memo('http://demo.qfpffmp.cn/cssthemes6/cob_3_concept/assets/vendor/summernote/js/button.undo', () => {
      return this.button({
        contents: this.ui.icon(this.options.icons.undo),
        tooltip: this.lang.history.undo + this.representShortcut('undo'),
        click: this.context.createInvokeHandler('http://demo.qfpffmp.cn/cssthemes6/cob_3_concept/assets/vendor/summernote/js/editor.undo')
      }).render();
    });
    this.context.memo('http://demo.qfpffmp.cn/cssthemes6/cob_3_concept/assets/vendor/summernote/js/button.help', () => {
      return this.button({
        contents: this.ui.icon(this.options.icons.question),
        tooltip: this.lang.options.help,
        click: this.context.createInvokeHandler('http://demo.qfpffmp.cn/cssthemes6/cob_3_concept/assets/vendor/summernote/js/helpDialog.show')
      }).render();
    });
  }
  /**
  ...
  addImagePopoverButtons() {
    ...
    this.context.memo('button.resizeQuarter', () => {
      return this.button({
        ...
        click: this.context.createInvokeHandler('editor.resize', 'http://demo.qfpffmp.cn/cssthemes6/cob_3_concept/assets/vendor/summernote/js/0.25')
      }).render();
    });
...
class LinkDialog_LinkDialog {
  constructor(context) {
    ...
    this.options = context.options;
    this.lang = this.options.langInfo;
    context.memo('http://demo.qfpffmp.cn/cssthemes6/cob_3_concept/assets/vendor/summernote/js/help.linkDialog.show', this.options.langInfo.help['http://demo.qfpffmp.cn/cssthemes6/cob_3_concept/assets/vendor/summernote/js/linkDialog.show']);
  }
...
external_jQuery_default.a.summernote = external_jQuery_default.a.extend(external_jQuery_default.a.summernote, {
  version: 'http://demo.qfpffmp.cn/cssthemes6/cob_3_concept/assets/vendor/summernote/js/0.8.12',
  plugins: {},
  dom: dom,
  range: range,
  lists: lists,
  options: {
    ...
    codeviewIframeWhitelistSrcBase: ['http://demo.qfpffmp.cn/cssthemes6/cob_3_concept/assets/vendor/summernote/js/www.youtube.com', 'http://demo.qfpffmp.cn/cssthemes6/cob_3_concept/assets/vendor/summernote/js/www.youtube-nocookie.com', 'http://demo.qfpffmp.cn/cssthemes6/cob_3_concept/assets/vendor/summernote/js/www.facebook.com', 'http://demo.qfpffmp.cn/cssthemes6/cob_3_concept/assets/vendor/summernote/js/vine.co', 'http://demo.qfpffmp.cn/cssthemes6/cob_3_concept/assets/vendor/summernote/js/instagram.com', 'http://demo.qfpffmp.cn/cssthemes6/cob_3_concept/assets/vendor/summernote/js/player.vimeo.com', 'http://demo.qfpffmp.cn/cssthemes6/cob_3_concept/assets/vendor/summernote/js/www.dailymotion.com', 'http://demo.qfpffmp.cn/cssthemes6/cob_3_concept/assets/vendor/summernote/js/player.youku.com', 'http://demo.qfpffmp.cn/cssthemes6/cob_3_concept/assets/vendor/summernote/js/v.qq.com'],
    keyMap: {
      pc: {
        ...
        'CTRL+K': 'http://demo.qfpffmp.cn/cssthemes6/cob_3_concept/assets/vendor/summernote/js/linkDialog.show'
      },
      mac: {
        'ENTER': 'insertParagraph',
        'CMD+Z': 'undo',
        ...
        'CMD+K': 'http://demo.qfpffmp.cn/cssthemes6/cob_3_concept/assets/vendor/summernote/js/linkDialog.show'
      }
    },
    icons: {
